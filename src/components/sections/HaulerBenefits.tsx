...
import { Route, Zap, QrCode, RefreshCcw } from "lucide-react";

export function HaulerBenefits() {
    const benefits = [
        {
            icon: Route,
            title: "Optimized Routes",
            description: "Multi-stop delivery planned by AI for maximum earnings per trip.",
            color: "text-orange-400",
        },
        {
            icon: Zap,
            title: "Instant Payment",
            description: "Get paid via UPI immediately when you complete a route.",
            color: "text-amber-400",
        },
        {
            icon: QrCode,
            title: "QR-Based Updates",
            description: "Scan QR codes at pickup and delivery. No manual paperwork.",
            color: "text-red-400",
        },
        {
            icon: RefreshCcw,
            title: "No Empty Returns",
            description: "AI plans round-trips so you're never driving empty.",
            color: "text-yellow-400",
        },
    ];

    return (
        <section id="benefits" className="py-24 relative overflow-hidden bg-black border-t border-white/5">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-radial from-white/5 to-transparent blur-3xl pointer-events-none" />
                ...
                >
                    ...
                    <motion.div variants={fadeInUp} className="text-center mb-16 flex flex-col items-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-6 leading-tight drop-shadow-lg">
                            Why Haulers Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-500">CropFresh</span>
                        </h2>
                        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed mb-2">
                            Join delivery partners who earn more with intelligent routing
                        </p>
                    </motion.div>
